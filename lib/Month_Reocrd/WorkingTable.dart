...
class Day_24hrPage extends StatefulWidget {
  late String name;
  late int c_day;
  Day_24hrPage({required this.name, required this.c_day});
  @override
  _Day_24hrPageState createState() => _Day_24hrPageState();
}

class _Day_24hrPageState extends State<Day_24hrPage> {
  String name='';
  int c_day=0;
  @override
